...
class ArchiveScreen extends StatelessWidget {
      ...
      body: Consumer<NoteProvider>(
        builder: (context, provider, child) {
          ...
          if (archivedNotes.isEmpty) {
            return const Center(child: Text('暂无归档记事'));
          }

          // Separate pinned and unpinned notes
          final pinnedNotes = archivedNotes.where((n) => n.isPinned).toList();
          final unpinnedNotes = archivedNotes
              .where((n) => !n.isPinned)
              .toList();
  ...
  List<Widget> _buildDateGroupedNotes(
    ...
    final groupedNotes = provider.groupNotesByDate(
      notes,
    ...
    return Slidable(
      ...
      startActionPane: ActionPane(
        ...
        children: [
          ...
          SlidableAction(
            onPressed: (context) => provider.unarchive(note),
